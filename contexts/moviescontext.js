  ...
  switch (action.type) {
    ...
    case ActionTypes.FETCH_TOP_BANNER_MOVIES_SUCCESS:
      return {
        ...state,
        loading: false,
        topBannerMovies: action.payload,
        error: null,
      };

    case ActionTypes.FETCH_TOP_BANNER_MOVIES_FAILURE:
      return { ...state, loading: false, error: action.payload };
    case ActionTypes.FETCH_ALL_MOVIES_REQUEST:
      return { ...state, loading: true, error: null };
    ...
    case ActionTypes.FETCH_ALL_MOVIES_FAILURE:
      return { ...state, loading: false, error: action.payload };
...
export const MovieProvider = ({ children }) => {
  ...
  const fetchTopBannerMovies = async () => {
    ...
    try {
      ...
      dispatch({
        type: ActionTypes.FETCH_TOP_BANNER_MOVIES_SUCCESS,
        payload: data,
      });
    } catch (error) {
      dispatch({
        type: ActionTypes.FETCH_TOP_BANNER_MOVIES_FAILURE,
        payload: error.message,
      });
    }
  };
  const fetchAllMovies = async () => {
    dispatch({ type: ActionTypes.FETCH_ALL_MOVIES_REQUEST });

    try {
      const response = await client.get("showMovies?toSearch=All");
      const data = await convertDataForFrontend(response.data);

      dispatch({ type: ActionTypes.FETCH_ALL_MOVIES_SUCCESS, payload: data });
    } catch (error) {
      dispatch({
        type: ActionTypes.FETCH_ALL_MOVIES_FAILURE,
        payload: error.message,
      });
    }
  };
  ...
  const fetchCommingSoonMovies = async () => {
    ...
    try {
      ...
      const data = await convertDataForFrontend(response.data);
      dispatch({
        type: ActionTypes.FETCH_COMING_SOON_MOVIES_SUCCESS,
        payload: data,
      });
    } catch (error) {
      dispatch({
        type: ActionTypes.FETCH_COMING_SOON_MOVIES_FAILURE,
        payload: error.message,
      });
    }
  };
  ...
  const fetchFeaturedMovies = async () => {
    ...
    try {
      ...
      dispatch({
        type: ActionTypes.FETCH_FEATURED_MOVIES_SUCCESS,
        payload: data,
      });
    } catch (error) {
      dispatch({
        type: ActionTypes.FETCH_FEATURED_MOVIES_FAILURE,
        payload: error.message,
      });
    }
  };
